...
export default function Header() {
  return (
    <>
      <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          <p className="text-sm/6 text-gray-100">
            <strong className="font-semibold">PixelHunter 2025</strong>
      ...
      <header className="bg-gray-600 text-white blur-1 p-6  shadow-md flex justify-between items-center">
        <h1 className="text-2xl font-bold">PixelHunter.V3</h1>
        <nav className="mt-2 ml-10">
          <ul className="flex gap-6">
            <li><img src="/path/to/profile-pic.jpg" alt="User Profile" className="h-8 w-8 rounded-full" /></li>
            <li>User name</li>
